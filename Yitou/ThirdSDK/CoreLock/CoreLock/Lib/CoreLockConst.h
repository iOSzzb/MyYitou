 ...
 *  外环线条颜色：默认
 */
#define CoreLockCircleLineNormalColor [UIColor whiteColor]


/*
 *  外环线条颜色：选中
 */
#define CoreLockCircleLineSelectedColor [UIColor whiteColor]


/*
 *  实心圆
 */
#define CoreLockCircleLineSelectedCircleColor [UIColor colorWithRed:0.36 green:0.75 blue:0.88 alpha:0.78]


/*
 *  实心圆
 */
#define CoreLockLockLineColor [UIColor whiteColor]
